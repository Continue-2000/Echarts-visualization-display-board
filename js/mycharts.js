...
(function () {
        ...
        series: [
            {
                ...
                type: 'line',
                smooth: true,
                data: [50, 30, 121, 135, 90, 215, 200, 230, 120, 220, 210, 120],
            },
            {
                name: '新增游客',
                type: 'line',
                smooth: true,
                data: [30, 54, 195, 324, 280, 330, 310, 213, 180, 250, 180, 79],
            },
    ...
    $('.panel').on('click', 'a', function () {
        let datas = yearData[$(this).index()].data
        datas.forEach(function (item, index) {
            option.series[index].data = item;
        })
        $(this).addClass('currenta').siblings('a').removeClass();
        myChart.setOption(option);
    });
